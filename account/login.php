                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" class="register-form" id="login-form" action="login.php">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="your_name" value="<?php echo $email ?>" placeholder="Your email"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="login-btn" id="signin" class="form-submit" value="Log in"/>
                            </div>
                        </form>
