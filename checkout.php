...
<html lang="en">
 ...
 <div class="container" id="myModalcontainer">
  <!-- The Modal -->
  <div class="modal " id="myModal" style="display: block;margin-top: 200px;">
    <div class="modal-dialog">
      <div class="modal-content">
      
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title text-danger">Hey</h4>
          <button type="button" class="close" data-dismiss="modal" onclick="close_mode();">&times;</button>
        </div>
        
        <!-- Modal body -->
        <div class="modal-body">
          Soon,you can purchase also...
        </div>
...
</div><!-- contanier of model ends here -->
